...
<robot>
    <link name="part{part_id}">
        ...
        <body name="part{part_id}" type="{body_type}" filename="{assembly_dir}/{part_id}.obj" {sdf_args} pos="0 0 0" quat="1 0 0 0" transform_type="OBJ_TO_JOINT" density="1" dx="{sdf_dx}" res="{sdf_res}" mu="0" rgba="{arr_to_str(part_color)}"/>
    </link>
</robot>
'''
    string += f'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gravity', type=float, default=9.8, help='magnitude of gravity')
    parser.add_argument('--friction', type=float, default=0.5, help='friction coefficient between parts')
