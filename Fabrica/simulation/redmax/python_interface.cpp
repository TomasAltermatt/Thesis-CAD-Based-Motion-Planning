...
PYBIND11_MODULE(redmax_py, m) {
    ...
    py::class_<Simulation>(m, "Simulation")
        ...
        .def("get_joint_init_transform", &Simulation::get_joint_init_transform,
                "get init transform",
                py::arg("joint_name"))
        .def("set_joint_init_transform", &Simulation::set_joint_init_transform,
                "set init transform",
                py::arg("joint_name"), py::arg("transform"))
        .def("apply_joint_init_transform", &Simulation::apply_joint_init_transform,
        ...
        .def("reset_state", &Simulation::reset_state,
                "reset state (q, qdot) as fixed init state")
        ...
        .def("set_u", &Simulation::set_u,
                "set u",
                py::arg("u"))
        .def("check_u_completed", &Simulation::check_u_completed,
                "check if u is completed",
                py::arg("pos_tol"), py::arg("vel_tol"), py::arg("verbose") = false)
        .def("check_u_completed_vec", &Simulation::check_u_completed_vec,
                "check if u is completed",
                py::arg("pos_tol"), py::arg("vel_tol"), py::arg("verbose") = false)
        ...
        .def("get_joint_qm", &Simulation::get_joint_qm,
                "get qm of the joint",
                py::arg("name"), py::arg("full_dof") = false)
        ...
        .def("get_joint_qm_from_q", &Simulation::get_joint_qm_from_q,
                "get qm of the joint from q",
        ...
        .def("get_body_mass", &Simulation::get_body_mass,
                ...
                py::arg("name"))
        .def("get_body_inertia", &Simulation::get_body_inertia,
        ...
        .def("get_body_E0j_map", &Simulation::get_body_E0j_map,
                "get E0j of the body")
        .def("get_body_qm", &Simulation::get_body_qm,
                "get qm of the body",
                py::arg("name"), py::arg("joint_rot") = true)
        .def("get_body_qm_from_joint_qm", &Simulation::get_body_qm_from_joint_qm,
                "get qm of the body from qm of the joint",
                py::arg("name"), py::arg("joint_qm"), py::arg("joint_rot") = true)
        .def("set_body_qm", &Simulation::set_body_qm,
                "set qm of the body",
                py::arg("name"), py::arg("qm"), py::arg("joint_rot") = true)
        ...
        .def("enable_body_gravity", &Simulation::enable_body_gravity,
                "enable gravity to the body",
                py::arg("name"))
        .def("disable_body_gravity", &Simulation::disable_body_gravity,
                "disable gravity to the body",
                py::arg("name"))
        ...
        .def("get_point_to_point_force", &Simulation::get_point_to_point_force,
                "Get point to point wrench as force/torque reading in local maximal coordinates",
                py::arg("name"))
        .def("get_ground_force", &Simulation::get_ground_force,
                "Get ground wrench as force/torque reading in local maximal coordinates",
                py::arg("name"))
        .def("get_SDF_force", &Simulation::get_SDF_force,
                "Get SDF wrench as force/torque reading in local maximal coordinates",
                py::arg("name"))
