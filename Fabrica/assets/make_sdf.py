...
<robot>
    <link name="part{part_id}">
        ...
        <body name="part{part_id}" type="SDF" filename="{assembly_dir}/{part_id}.obj" save_sdf="true" pos="0 0 0" quat="1 0 0 0" transform_type="OBJ_TO_JOINT" density="1" dx="{sdf_dx}" mu="0"/>
    </link>
</robot>
'''
    string += f'''
...
def make_sdf(assembly_dir, sdf_dx):
...
if __name__ == '__main__':
    ...
    if args.clear:
        clear_saved_sdfs(args.dir)
    else:
        make_sdf(args.dir, args.sdf_dx)
